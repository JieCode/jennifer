package com.jennifer.jennifer.ui.speech;
...
import com.jennifer.jennifer.view.SpeechRecognizerLayout;

public class SpeechRecognizerActivity extends BaseActivity implements View.OnTouchListener, SpeechRecognizerLayout.OnSpeechListener {
    private static final String TAG = SpeechRecognizerActivity.class.getSimpleName();
    private TextView tvSpeech;
    private SpeechRecognizerLayout btnSpeech;
    ...
    private void initData() {
        ...
        btnSpeech = findViewById(R.id.speech_layout);
        btnSpeech.setListener(this);
...
//开始识别，并设置监听器
    ...
    @Override
    public void onSend(String result) {
        StringBuilder builder = new StringBuilder(tvSpeech.getText().toString());
